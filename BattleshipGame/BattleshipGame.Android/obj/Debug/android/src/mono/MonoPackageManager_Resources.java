...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "BattleshipGame.Android.dll" comes first in this list. */
		"BattleshipGame.Android.dll",
		"Autofac.dll",
		"BattleshipGame.Application.dll",
		"BattleshipGame.Domain.dll",
		"FormsViewGroup.dll",
		"MediatR.dll",
